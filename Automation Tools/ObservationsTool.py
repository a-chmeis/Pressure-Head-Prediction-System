...
url = 'http://foodie.lesprojekt.cz:8080/senslogOT2/rest/observation?unit_id=4151559&from_time=2021-02-16&to_time=2021-02-23'

response = urllib.request.urlopen(url)
data = json.load(response)  


with open('~ownCloud/Thesis/Case study/temporary/observations.json', 'w') as f1:
    json.dump(data, f1)
    
with open('~ownCloud/Thesis/Case study/temporary/observations.json') as input_file:
